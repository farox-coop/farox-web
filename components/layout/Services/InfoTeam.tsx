...
function InfoTeam() {
  ...
  return (
    <article
      className="w-full bg-[#f1f1f1] relative px-8 scroll-mt-22 tablet:scroll-mt-30 laptop:scroll-mt-10"
      id="team-extension"
    >
      <section className="max-w-screen-desktoplg relative mx-auto mt-6 tablet:mt-14 laptop:mt-24 flex w-full flex-col items-center">
        ...
        <div className="flex flex-col text-base laptop:flex-row laptop:gap-15 w-full mt-9.5 laptop:text-2xl desktop:text-3xl desktoplg:text-[34px] max-w-75 tablet:max-w-full">
