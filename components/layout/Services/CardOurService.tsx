...
export default function CardCase({
  ...
  return (
    <LinkView
      href={url}
      className="flex flex-col gap-6 tablet:gap-24 laptop:gap-3 laptop:justify-center items-center w-full max-w-[236px] tablet:max-w-[497px] laptop:w-[300px] desktop:w-auto laptop:max-w-[310px] desktop:max-w-[410px] desktoplg:max-w-[497px] h-[169px] tablet:h-[385px] laptop:h-[260px] desktop:h-[330px] desktoplg:h-[470px] bg-black/85 text-white relative fill-primary hover:fill-secondary px-8 tablet:px-2 desktop:px-3 desktoplg:px-8 p-4 box-content transition-colors duration-300 group"
    >
